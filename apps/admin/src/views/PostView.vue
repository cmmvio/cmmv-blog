                ...
                <div class="border-b border-neutral-700">
                    ...
                    <div v-show="expandedSections.tags" class="p-4 pt-0 space-y-4">
                        <div>
                            ...
                            <div v-else
                                class="space-y-2 max-h-48 overflow-y-auto p-2 bg-neutral-700 border border-neutral-600 rounded-md">
                ...
                <div class="border-b border-neutral-700">
                    ...
                    <div v-show="expandedSections.seo" class="p-4 pt-0 space-y-4">
                        ...
                        <div>
                            ...
                            <input v-model="post.canonicalUrl" type="text"
                                class="w-full px-3 py-2 bg-neutral-700 border border-neutral-600 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500"
...
// Add these functions for feature image handling
// Update feature image button handler
...
// Initialize feature crop canvas
function initFeatureCropCanvas() {
    ...
    // Set fixed dimensions for the canvas (16:9 aspect ratio for feature images)
    canvas.width = 600
    canvas.height = 338
...
// Draw feature image on canvas with current zoom level
...
// Handle wheel zoom for feature image
...
// Crop feature image and update post
function cropFeatureImage() {
    ...
    // Draw only the visible portion of the image to the temp canvas
    tempCtx.drawImage(
        selectedFeatureImage.value,      // source image
    ...
    const base64Image = tempCanvas.toDataURL('image/jpeg', 0.85) // 0.85 quality for compression
...
// Add this function before the saveDraft function
async function savePost() {
    try {
        // Prepare post data with current editor content
        const postData = {
            ...post.value,
