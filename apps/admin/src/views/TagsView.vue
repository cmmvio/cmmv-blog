    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div class="text-sm text-neutral-400">
                ...
                <span class="font-medium text-white">{{ pagination.total }}</span> tags
            </div>
            ...
            <div class="bg-neutral-800 rounded-lg shadow-lg w-full max-w-md mx-auto">
                ...
                <div class="p-6">
                    <p class="text-neutral-300 mb-4">
                        Are you sure you want to delete the tag <span class="font-medium text-white">{{ tagToDelete?.name }}</span>?
                    </p>
                    <p class="text-sm text-neutral-400 mb-6">
                        This action cannot be undone. All posts using this tag may be affected.
                    </p>
