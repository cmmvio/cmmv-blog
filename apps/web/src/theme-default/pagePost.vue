<template>
    <div class="lg:ml-64">
        ...
        <div v-else class="article-container lg:max-w-4xl md:max-w-3xl">
            ...
            <div v-if="author" class="mt-10 mb-10 p-6 bg-gray-50 rounded-lg border border-gray-200">
                <div class="flex items-center mb-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p v-if="author.location" class="text-xs text-gray-600 flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <!-- Author Bio -->
                <div v-if="author.bio" class="text-sm leading-relaxed text-gray-700 mb-4">
                    {{ author.bio }}
                </div>
...
const author = ref(post.value.authors.find(
